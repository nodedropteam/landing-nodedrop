...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("font-medium leading-relaxed text-xl sm:text-3xl", className)}
    {...props}
  />
))
...
>(({ className, alt, ...props }, ref) => (
  <img
    ref={ref}
    className={cn("absolute h-40 left-0 bottom-0 w-full rounded-t-xl object-cover", className)}
    alt={alt}
    {...props}
  />
))
